...
mkdir /etc/newadm/demo-ssh 2>/dev/null
SCPdir="/etc/newadm"
...
echo -e "\e[1;96m      CREAR USUARIO POR TIEMPO LIMITE \e[1;97m(Minutos)"
msg -bar
echo -e "\e[1;97m Los Usuarios creados en esta opcion se eliminaran\n automaticamente pasado el tiempo designado.\e[0m"
msg -bar
...
rm -rf /tmp/cmd
touch /etc/newadm/demo-ssh/$name
