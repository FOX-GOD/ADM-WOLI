...
msg -bar
msg -tit
echo -e "\033[1;32m          INSTALADOR DE OPENVPN | VPS-BO"
msg -bar
	# OpenVPN setup and first user creation
echo -e "\033[1;97mSe necesita ciertos parametros para configurar OpenVPN."
...
coleta_variaveis () {
echo -e "\033[1;32m     INSTALADOR DE OPENVPN | VPS-GHOST "
msg -bar
